...
| Stage 2c DQ stress test | `run_plasmode_dq_stress()` minimax rule | Each scenario within thresholds across severities | GO | Selected candidate is stable across prespecified threats | Software-enforced |
