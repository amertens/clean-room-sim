...
association is examined. This is the strongest claim we make for
cleanTMLE: it links candidate-estimator selection and
fit-for-purpose concerns on a single quantitative scale before
outcome access.
...
still admitting valid Wald-type confidence intervals. The package
...
personnel-based outcome-blinding arrangement so that both the
institutional and the computational safeguards apply.
...
post-outcome quantitative bias analysis.
...
a *proceed* classification. Three of the five prespecified
