...
correctly returned STOP, illustrating that the workflow can
identify settings where the available data do not support the
causal estimand. The data-quality stress test further showed that
...
independent checkpoint review. Section §\ref{sec-roadmap} situates
...
institutional and the computational guarantees apply.
